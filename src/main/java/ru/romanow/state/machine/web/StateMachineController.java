...
public class StateMachineController {
    ...
    public String nextState(@PathVariable String type, @PathVariable UUID calculationUid) {
        return calculationService.nextState(CalculationType.find(type), calculationUid);
    }
}
